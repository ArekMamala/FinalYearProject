...
\textbf{GitHub Link:}\\https://github.com/ArekMamala/FinalYearProject\\
\textbf{Screencast Link:}\\
\textbf{Project Video - Usman Sattar: }\\
\textbf{Project Video - Sammar Tahir: }\\
\textbf{Project Video - Arkadiusz Mamala: }\\
\textbf{Punching Detection video: }\\
https://github.com/ArekMamala/FinalYearProject/blob/master/ProjectVideos/punching%20video.mp4
...
\\
\textbf{Second Step:}
During the term our research is going to be a piece of document in how this wearable device can be achieved and possible drawing and animations of how it may work. But to back up our research, we need a physical piece that we can show and present. So we as a group decided to construct an application that is downloadable on mobile phone. This phone application is an alternative to the wearable device. The application is going to record the number of punches. The application is going to record and store data. For example is it going to store the number of punches under a certagin amount of time.
\\
\textbf{Third Step:}
...
\textbf{Work Allocation - Usman Sattar}

\textbf{Work Allocation - Sammar Tahir}

\textbf{Work Allocation - Arkadiusz Mamala}
...
There were many types of research taken into consideration for this sprint. This ranged from articles from Google Scholar including articles from universities, stack overflow, videos, and information from genuine sources. We reviewed many books, articles and papers with the help of Google School and the GMIT library resourse available through GMIT's website.
\newpage
\textbf{Environments}\\
...
backlog- is a list of them

discuss, sketch, software

sprint planner
stage in srum, srum is the methodolofy
...
Respond with all the information regarding 'Monday' when a GET request is made to the mealday1 page. We made the weekday into an unique ID. Although all the weekdays are in the same table with the database, but we access them by the days. For example we call all the information relating to 'Monday' to be printed out.
\newpage
