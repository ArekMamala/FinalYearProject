...
\subsubsection{Benefits of having a nutritious diet}
\begin{itemize}
...
\subsubsection{Nutrition for Athletes}
...
\cite{Nutrition}
\subsubsection{Building and Repairing Muscle}
...
\cite{Supplements}
\subsubsection{Impact of Supplements}
...
It was clear to us that the following frameworks, sdk's would be necessary in the application to make it user friendly, ascetically pleasing and to give us the ability for the project to be developed on a work friendly platform.
...
Angular CLI is a  command line interface that helps to simplify the developing of high quality applications Angular applications. 

With angular CLI we are able to, develop, test, build, and deploy an Angular applications with very little trouble.

This interface provides us with such commands 
...
\subsubsection{ Reflection on survey} 
...
\begin{center}
\includegraphics[scale=.3]{images/statistic1.png}\includegraphics[scale=.3]{images/statistic2.png}
\end{center}
